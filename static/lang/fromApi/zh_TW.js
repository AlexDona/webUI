export const fromApi = {
  ...
  'account_failure_00130': '賬戶資產異常，不能進行該操作',
  ...
  'account_failure_0066': '用戶資產快照失敗！',
  'account_failure_0067': '用戶可用到鎖倉失敗！',
  'account_failure_0068': '用戶可用到鎖倉失敗,日誌記錄失敗！',
  'account_failure_0069': '用戶鎖倉不足，無法處理！',
  'account_failure_0070': '用戶鎖倉不足，無法處理！',
  'account_failure_0071': '用戶鎖倉到賬异常！',
  'account_failure_0072': '用戶充值記錄不存在或已修改',
  'CANCEL': '已取消',
  'cancel_withdraw_error': '取消提現失敗',
  ...
  'FINISHED': '已完成',
  'FREEZE': '凍結',
  'ieo_failure_001': '未在申購時間不能申購',
  'ieo_failure_002': '超出募集最大總量',
  'ieo_failure_003': '未滿足起購數量',
  'ieo_failure_004': '超出單人限額',
  'ieo_failure_005': '項目不存在',
  'ieo_failure_006': '用戶需持倉幣種數量不足',
  'ieo_interest_return_return_all_expired': '到期返息',
  'ieo_order_status_completed': '已完成',
  'ieo_order_status_expired': '已到期',
  'ieo_order_status_locked': '鎖定中',
  'ieo_project_status_coming': '即將開始',
  'ieo_project_status_ended': '已結束',
  'ieo_project_status_ongoing': '進行中',
  'invalid_user_info': '無效的用戶信息',
  'IS_DISTRIBUTE': '發放收益',
  ...
  'otc_failure_0098': '您當前您當前有未完成訂單，請完成訂單後繼續下單有未完成訂單',
  ...
  'recharge_withdraw_failure_0047': '獲取幣種信息失敗',
