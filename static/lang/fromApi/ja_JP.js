export const fromApi = {
  ...
  'account_failure_00130': 'アカウント資産が異常であり、操作できません。',
  'account_failure_00131': 'アカウントの資産が異常であり、取引ステータスが無効になっています。',
  ...
  'account_failure_0066': 'ユーザー資産スナップショットが失敗しました。',
  'account_failure_0067': 'ユーザーがボックスをロックできませんでした。',
  'account_failure_0068': 'ユーザーはロックをロックできませんでした、ログレコードは失敗しました！',
  'account_failure_0069': 'ユーザーのロックアウトが不十分で、処理できません。',
  'account_failure_0070': 'ユーザーのロックアウトが不十分で、処理できません。',
  'account_failure_0071': 'ユーザのロック・ビンが冻结異常!',
  'account_failure_0072': 'ユーザデポジット記録は存在しない、または修正された',
  'CANCEL': '취소됨',
  'cancel_withdraw_error': 'キャンセルキャンセルに失敗しました',
  ...
  'FINISHED': '完了しました',
  'FREEZE': 'フリーズ',
  'ieo_failure_001': '申し込みの時間でないと買えません。',
  'ieo_failure_002': '募集の最大総量を超えます。',
  'ieo_failure_003': '発注数量を満足していません。',
  'ieo_failure_004': 'シングルの制限を超える',
  'ieo_failure_005': 'プロジェクトは存在しません',
  'ieo_failure_006': 'ユーザーがロックトークン数量足りない',
  'ieo_interest_return_return_all_expired': '期限になって利息を返す',
  'ieo_order_status_completed': '完了',
  'ieo_order_status_expired': '期限が切れました',
  'ieo_order_status_locked': 'ロック中',
  'ieo_project_status_coming': 'もうすぐ始まります',
  'ieo_project_status_ended': '終了',
  'ieo_project_status_ongoing': '進行中',
  'invalid_user_info': '無効なユーザー情報',
  ...
  'otc_failure_0098': '現在未完成の注文があります。注文を終えてから注文を続けてください。',
  ...
  'recharge_withdraw_failure_0047': '通貨情報を取得できませんでした',
