export const personal = {
  ...
  'user_asset_title15': '実名認証を完了してから、出金操作を行ってください',
  'user_asset_title16': '高级認証を完了してから、出金操作を行ってください',
  'user_asset_title17': '先ず実名認証を行ってください',
  'user_hidden_assets': '零資産は隠す',
  'user_not_real_name': '未名前認証',
  'user_by_real_name': '実名認証',
  'user_open_email_enabled': 'メールボックス認証オン',
  'user_open_phone_enabled': 'モバイル認証オン',
  'user_open_google_enabled': 'Google認証オン',
  'user_not_email_enabled': 'メールボックス認証オフ',
  'user_not_phone_enabled': 'モバイル認証オフ',
  ...
  'user_assets_recharge_hint4': 'この住所に再送金すると、送金が完了し、ネットワークが自動的に確認するのを待ってからシステムが自動的に到着します（{}件の確認）。',
  'user_assets_recharge_hint5': '迅速に到着するには、充電時にネットワーク料金を増やすことができます。',
  'user_assets_recharge_hint6': '最小リチャッジ金額{}。」',
  ...
  'user_assets_withdrawal_hint10': '{}コインはOMNIタイプのみをサポートしており、他のタイプのコインを使用することは一時的に利用できません。',
  ...
  'user_api_text0': '',
  'user_api_text01': 'によって使用方法を見てみます。',
  'user_api_text1': 'このプラットフォームは、引用、自動取引などを使用できる強力なAPIを提供します。',
