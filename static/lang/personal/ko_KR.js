export const personal = {
  ...
  'user_asset_title15': '먼저 실명 인증하세요.',
  'user_asset_title16': '먼저 고급 인증하고 출금하세요',
  'user_asset_title17': '먼저 실명 인증하고 출금하세요',
  'user_hidden_assets': '통화가 0 인 자산 숨기기',
  'user_not_real_name': '미실명 인증',
  'user_by_real_name': '실명 인증',
  'user_open_email_enabled': '메일박스 확인',
  'user_open_phone_enabled': '휴대폰 검증',
  'user_open_google_enabled': '구글 검증',
  'user_not_email_enabled': '메일박스 확인 없음',
  'user_not_phone_enabled': '휴대폰 검증 없음',
  ...
  'user_inviter_tips': '초청자 저장 후 수정할 수 없음',
  ...
  'user_transaction_info': '자금 안전을 위해 거래 비밀번호를 재설정 한 후 24 시간 이내에 동전 및 PUSH 자산 철회와 같은 민감한 작업을 사용할 수 없습니다.',
  // 登录密码
  ...
  'user_vip_lack_of_available': '사용 가능 성이 부족하다',
