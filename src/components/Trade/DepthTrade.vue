...
export default {
      ...
      this.depthCharts.setOption({
        ...
        tooltip: {
          ...
          formatter: function (params) {
            console.log(params)
            return `
                      委托量：${params[0].data[0].toFixed(4)}<br/>
                      委托价：${params[0].data[1].toFixed(4)}
                      `
          }
        },
        xAxis: {
  ...
  computed: {
    ...mapState({
      ...
      buys: state => state.common.socketData.depthData.buy,
      sells: state => state.common.socketData.depthData.sell
    })
    // buys () {
