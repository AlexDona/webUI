  ...
  .recharge-list.recharge-list-mention.list-mention-treasure(
    ...
    .recharge-list-left.display-flex
      ...
      .text-info-mention.flex1.font-size12(:class="{'need-tag-top':isNeedTag}")
        ...
        // 每日提币，每日最多提币
        p.prompt-message.cursor-pointer(v-if="feeRangeOfWithdraw.withdrawCount" :title="$t('M.user_assets_withdrawal_limits').format([feeRangeOfWithdraw.withdrawCount]) + ', ' + (feeRangeOfWithdraw.withdrawCoinCount ? $t('M.user_assets_withdrawal_count').format([feeRangeOfWithdraw.withdrawCoinCount]) + currencyName : $t('M.user_assets_withdrawal_uncounted'))") *  {{ $t('M.user_assets_withdrawal_limits').format([feeRangeOfWithdraw.withdrawCount]) + ', ' + (feeRangeOfWithdraw.withdrawCoinCount ? $t('M.user_assets_withdrawal_count').format([feeRangeOfWithdraw.withdrawCoinCount]) + currencyName : $t('M.user_assets_withdrawal_uncounted')) }}
        p.prompt-message.cursor-pointer(v-else :title="$t('M.user_assets_withdrawal_unlimited') + ', ' + (feeRangeOfWithdraw.withdrawCoinCount ? $t('M.user_assets_withdrawal_count').format([feeRangeOfWithdraw.withdrawCoinCount]) + currencyName : $t('M.user_assets_withdrawal_uncounted'))") *  {{ $t('M.user_assets_withdrawal_unlimited') + ', ' + (feeRangeOfWithdraw.withdrawCoinCount ? $t('M.user_assets_withdrawal_count').format([feeRangeOfWithdraw.withdrawCoinCount]) + currencyName : $t('M.user_assets_withdrawal_uncounted')) }}
        // 提币
        p.mention-button
