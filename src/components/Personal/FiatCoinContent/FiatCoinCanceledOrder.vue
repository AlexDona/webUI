  ...
  >
    <div class="canceled-order-content">
      ...
      >
        ...
        <div class="canceled-info-bottom box-sizing">
          <div class="info-left box-sizing">
            ...
            <!--展示客服判定结果-->
            <p class="text-info" v-if="item.appeal == 'YES'">
              {{item.handleSuggest}}
            </p>
            <!--主动取消的展示：买家主动取消订单-->
            <p class="text-info" v-else-if="item.whoCancel === '1' && item.appeal == 'NO'">
              {{$t('M.otc_cancel_order_buyer_initiative_cancel')}}
            </p>
            <!--卖家超时未付款，系统自动取消-->
          ...
          <div class="info-right box-sizing">
            ...
            <p
              ...
              v-if="item.appeal == 'NO'"
            >
              {{$t('M.otc_cancel_order_buyer_cancel')}}
            </p>
            <!-- 申诉取消 -->
            <p
              class="text-info text-blue"
            ...
            >
              {{$t('M.otc_cancel_order_appeal_cancel')}}
            </p>
            <!--取消时间-->
            <p class="text-info">
      ...
      <el-pagination
        class="pages"
        background
        v-show="OTCCanceledOrderList.length && legalTradePageTotals - 1 > 0"
