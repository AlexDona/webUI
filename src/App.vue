...
export default {
  ...
  watch: {
    '$route' (to, from) {
      ...
      document.querySelector('meta[name="viewport"]').setAttribute('content', `width=device-width, initial-scale=${isLoginOrRigister ? '1' : '0.5'}, minimum-scale=0.1, maximum-scale=1, user-scalable=${isLoginOrRigister ? 'no' : 'yes'}`)
